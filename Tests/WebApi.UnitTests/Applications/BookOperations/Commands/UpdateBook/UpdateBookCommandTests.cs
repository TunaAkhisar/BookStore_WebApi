...
public class UpdateBookCommandTests : IClassFixture<CommonTestFixture>
{
	...
	public void WhenNonValidIdIsGiven_Book_ShoulBeReturn()
	{
		...
		FluentActions.Invoking(() => command.UpdateHandle()).Should().Throw<InvalidOperationException>().And.Message.Should().Be("Book doesn't exist!");
	}
	...
	public void WhenValidInputsAreGiven_Book_ShouldBeUpdated()
	{
		...
		FluentActions.Invoking(() => command.UpdateHandle()).Invoke();
